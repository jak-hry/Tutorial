...
public class CrudAppTestSuite {
    ...
    private static final String BASE_URL = "https://jak-hry.github.io/";
    ...
    private boolean checkTaskExistsInTrello(String taskName) throws InterruptedException {
        ...
        driverTrello.findElements(By.xpath("//a[@class=\"board-tile\"]")).stream()
                .filter(aHref -> aHref.findElements(By.xpath(".//div[@title=\"Witaj w Trello!\"]")).size() > 0)
    ...
    private void deleteCrudAppTestTask(String taskName) throws InterruptedException {
        final String XPATH_DELETE_BUTTON = "//form[contains(.,'" + taskName + "')]/div/fieldset[1]/button[4]";
