...
public class BookTestSuite {
    ...
    void testGetListUsingIntStream() {
        ...
        long numberOfBooksPublicatedAfter2008 = IntStream.range(0, books.size())
                .filter(n -> books.get(n).getYearOfPublication() > 2008)
                .count();

        assertEquals(3, numberOfBooksPublicatedAfter2007);
        assertEquals(3, numberOfBooksPublicatedAfter2008);
    }
}
